...
export const UI = {
  home: {
    ...
    steps: ['Elige tu sector', 'Responde 4 escenarios', 'Gana monedas Aha', 'Descubre tu Power-Up'],
    cta: '¡Jugar!',
  ...
  resultado: {
    ...
    answers: 'Tus respuestas y monedas Aha',
